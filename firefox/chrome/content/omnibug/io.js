...
if (typeof(JSIO) != 'boolean') {
    ...
    var FileIO = {
        ...
        dirserviceIID : Components.interfaces.nsIProperties,

        getTmpDir : function() {
            return Components.classes[this.dirserviceCID]
                          .createInstance(this.dirserviceIID)
                          .get("TmpD", Components.interfaces.nsIFile);
        },

        append : function( file, name ) {
            try {
                file.append( name );
                return file;
            } catch( e ) {
