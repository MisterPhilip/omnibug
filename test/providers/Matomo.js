...
import { default as MatomoProvider } from "../source/providers/Matomo.js";
import { OmnibugProvider } from "../source/providers.js";

test("MatomoProvider returns provider information", t => {
    let provider = new MatomoProvider();
    t.is(provider.key, "MATOMO", "Key should always be MATOMO");
    t.is(provider.type, "Analytics", "Type should always be Analytics");
    t.is(provider.name, "Matomo", "Name should be returned as Matomo");
    t.true(typeof provider.pattern === 'object' && provider.pattern instanceof RegExp, "Pattern should be a RegExp value");
});

test("MatomoProvider pattern should match Matomo URLs", t => {
    let provider = new MatomoProvider(),
        urls = [
            "https://omnibug.matomo.cloud/matomo.php?action_name=",
            "https://omnibug.matomo.cloud/piwik.php?action_name=",
            "https://omnibug.matomo.cloud/matomo/matomo.php?action_name=",
            "https://matomo.omnibug.io/matomo.php?action_name="
        ],
        ignoreUrls = [
            "https://omnibug.io/matomo",
            "https://matomo.omnibug.io/matomo.js"
        ];
...
test("OmnibugProvider returns MatomoProvider", t => {
    let url = "https://omnibug.matomo.cloud/matomo.php?action_name=&idsite=1&rec=1&r=037654&h=13&m=12&s=57&url=http%3A%2F%2Flocalhost%2Fmatomo.html&_id=6a45e22e58f0786b&_idts=1575143580&_idvc=1&_idn=0&_refts=0&_viewts=1575143580&_ects=1575144372&cs=windows-1252&send_image=1&pdf=1&qt=0&realp=0&wma=0&dir=0&fla=0&java=0&gears=0&ag=0&cookie=1&res=2560x1440&gt_ms=1&pv_id=wYQaNh";

    let results = OmnibugProvider.parseUrl(url);
    t.is(results.provider.key, "MATOMO", "Results provider should be Matomo");
});

test("MatomoProvider returns static data", t => {
    let provider = new MatomoProvider(),
        url = "https://omnibug.matomo.cloud/matomo.php?action_name=&idsite=1&rec=1&r=037654&h=13&m=12&s=57&url=http%3A%2F%2Flocalhost%2Fmatomo.html&_id=6a45e22e58f0786b&_idts=1575143580&_idvc=1&_idn=0&_refts=0&_viewts=1575143580&_ects=1575144372&cs=windows-1252&send_image=1&pdf=1&qt=0&realp=0&wma=0&dir=0&fla=0&java=0&gears=0&ag=0&cookie=1&res=2560x1440&gt_ms=1&pv_id=wYQaNh";

    let results = provider.parseUrl(url);

    t.is(typeof results.provider, "object", "Results should have provider information");
    t.is(results.provider.key, "MATOMO", "Results provider is Matomo");
    t.is(typeof results.data, "object", "Results should have data");
    t.true(results.data.length > 0, "Data should be returned");
});

test("MatomoProvider returns host data", t => {
    let provider = new MatomoProvider(),
        url = "https://omnibug.matomo.cloud/matomo.php?action_name=&idsite=1&rec=1&r=037654&h=13&m=12&s=57&url=http%3A%2F%2Flocalhost%2Fmatomo.html&_id=6a45e22e58f0786b&_idts=1575143580&_idvc=1&_idn=0&_refts=0&_viewts=1575143580&_ects=1575144372&cs=windows-1252&send_image=1&pdf=1&qt=0&realp=0&wma=0&dir=0&fla=0&java=0&gears=0&ag=0&cookie=1&res=2560x1440&gt_ms=1&pv_id=wYQaNh";
    ...
    t.is(mboxHost.field, "Page URL", "Page URL should be returned");
    t.is(mboxHost.value, "http://localhost/matomo.html", "Page URL should be omnibug.io");
});

test("MatomoProvider returns custom data", t => {
    let provider = new MatomoProvider(),
        url = "https://omnibug.matomo.cloud/matomo.php?idgoal=2&revenue=200&idsite=1&rec=1&r=056124&h=13&m=15&s=36&url=http%3A%2F%2Flocalhost%2Fmatomo.html&_id=6a45e22e58f0786b&_idts=1575143580&_idvc=1&_idn=0&_refts=0&_viewts=1575143580&_ects=1575144372&cs=windows-1252&send_image=1&pdf=1&qt=0&realp=0&wma=0&dir=0&fla=0&java=0&gears=0&ag=0&cookie=1&res=2560x1440&gt_ms=1&pv_id=wYQaNh";
    ...
    t.is(trackingServer.value, "omnibug.matomo.cloud");
...
test("MatomoProvider returns custom variables", t => {
    ...
    t.is(var1name.field, "Custom Variable 1 Name");
    t.is(var1name.value, "VisitorType");
    t.is(var1name.group, "custom");
    t.is(var2value.field, "Custom Variable 2 Value");
    t.is(var2value.value, "Gold Star");
    t.is(var2value.group, "custom");
});

test("MatomoProvider returns custom dimensions", t => {
    let provider = new MatomoProvider(),
        url = "https://omnibug.matomo.cloud/matomo.php?action_name=&idsite=1&rec=1&r=336484&h=13&m=21&s=8&url=http%3A%2F%2Flocalhost%2Fmatomo.html&_id=6a45e22e58f0786b&_idts=1575143580&_idvc=1&_idn=0&_refts=0&_viewts=1575143580&_ects=1575144372&cs=windows-1252&send_image=1&pdf=1&qt=0&realp=0&wma=0&dir=0&fla=0&java=0&gears=0&ag=0&cookie=1&res=2560x1440&dimension1=Member&dimension652=Gold%20Star&gt_ms=1&pv_id=OJeSct";
...
test("MatomoProvider handles request types", t => {
    let provider = new MatomoProvider(),
